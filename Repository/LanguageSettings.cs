    ...
    public class LanguageSettings
    {
        ...
        public LanguageModel LanguageList(int indexNumber)
        {
            ...
            LM.Add(new LanguageModel
            {
                ...
                ComboBox_SortingMethods = new String[] { "Sidste redigeret dato", "Skaber Dato", "Alfabetisk (abc)", "Flyt" },
            ...
            LM.Add(new LanguageModel 
            {
                ...
                TextBox_ErrorMsgBox = new String[] { "", "• Error: Not all fields are selected!", "• Error: NO image files found!", "• Error: Try anothe path" },

                TextBox_SortingMethod = "Sorting Methods",
                ComboBox_SortingMethods = new String[] { "Last Modefied Date", "Created Date", "Alfabetic (abc)", "Move" },

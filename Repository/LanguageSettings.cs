    ...
    public class LanguageSettings
    {
        ...
        public LanguageModel LanguageList(int indexNumber)
        {
            ...
            LM.Add(new LanguageModel
            {
                ...
                TextBox_ErrorMsgBox = new String[] { "", "• Fejl: Ikke alle felter er udfyldt!", "• Fejl: Ingen billeder filer blev fundet!", "• Fejl: Prøv en anden sti", "• Fejl: Noget gik galt. Genstart programmet og prøv igen!" },
            ...
            LM.Add(new LanguageModel 
            {
                ...
                TextBox_ErrorMsgBox = new String[] { "", "• Error: Not all fields are selected!", "• Error: NO image files found!", "• Error: Try anothe path", "Error: Something went wrong. Restart the program and try again!" },
